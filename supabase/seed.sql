...
insert into public.tasks (id, project_id, title, description, status, priority, assignee_id, reporter_id, start_date, due_date, estimated_hours, actual_hours, purchase_items)
values
  ('55555555-5555-5555-5555-555555555551', '44444444-4444-4444-4444-444444444441', 'Finalize SSO rollout plan', 'Coordinate launch checklist with security and customer success.', 'In Progress', 'Urgent', '22222222-2222-2222-2222-222222222222', '11111111-1111-1111-1111-111111111111', current_date - interval '6 days', current_date + interval '3 days', 16, 9, '[{"id":"pi-sso-brief","name":"Rollout briefing packet"},{"id":"pi-sso-headsets","name":"Headsets for launch rehearsal"}]'::jsonb),
  ('55555555-5555-5555-5555-555555555552', '44444444-4444-4444-4444-444444444441', 'Polish executive dashboard metrics', 'Refine data cards and validate refresh timing with finance.', 'In Review', 'High', '33333333-3333-3333-3333-333333333333', '22222222-2222-2222-2222-222222222222', current_date - interval '8 days', current_date + interval '1 day', 12, 11, '[]'::jsonb),
  ('55555555-5555-5555-5555-555555555553', '44444444-4444-4444-4444-444444444442', 'Map automation dependencies', 'Confirm source systems, owners, and exceptions.', 'Not Started', 'Medium', '22222222-2222-2222-2222-222222222222', '11111111-1111-1111-1111-111111111111', current_date + interval '1 day', current_date + interval '8 days', 10, null, '[{"id":"pi-automation-license","name":"Sandbox connector license"}]'::jsonb),
  ('55555555-5555-5555-5555-555555555554', '44444444-4444-4444-4444-444444444443', 'Close stale admin access', 'Remove unused elevated permissions across production systems.', 'Blocked', 'Urgent', '11111111-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111', current_date - interval '14 days', current_date - interval '2 days', 8, 6, '[]'::jsonb),
  ('55555555-5555-5555-5555-555555555555', '44444444-4444-4444-4444-444444444443', 'Draft rollback checklist', 'Prepare release checklist for incident response and rollback.', 'Done', 'High', '33333333-3333-3333-3333-333333333333', '11111111-1111-1111-1111-111111111111', current_date - interval '12 days', current_date - interval '5 days', 6, 5, '[{"id":"pi-printouts","name":"Printed rollback runbook"}]'::jsonb)
on conflict (id) do nothing;
